...
audit_windows_file() {
  ...
  while IFS= read -r dependency; do
    ...
    case "$upper" in
      ADVAPI32.DLL|BCRYPT.DLL|BCRYPTPRIMITIVES.DLL|CRYPT32.DLL|D3D12.DLL|DIRECTML.DLL|DNSAPI.DLL|DXGI.DLL|GDI32.DLL|IPHLPAPI.DLL|KERNEL32.DLL|MSVCRT.DLL|NORMALIZ.DLL|NTDLL.DLL|OLE32.DLL|OLEAUT32.DLL|POWRPROF.DLL|RPCRT4.DLL|SECUR32.DLL|SHELL32.DLL|USER32.DLL|USERENV.DLL|WS2_32.DLL|API-MS-WIN-CORE-*.DLL|API-MS-WIN-CRT-*.DLL) ;;
      *)
